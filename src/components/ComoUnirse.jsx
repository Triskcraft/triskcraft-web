    ...
    <div className="relative overflow-hidden rounded-3xl border border-triskgold/25 bg-gradient-to-r from-[#0a1b15] via-triskgreen to-[#0f3229] p-8 shadow-2xl md:p-12">
      ...
      <div className="relative grid items-center gap-8 md:grid-cols-2">
        <div className="order-2 flex flex-col gap-4 md:order-1">
          <p className="text-sm uppercase tracking-[0.3em] text-triskgold/80">Únete</p>
          <h2 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">¿Cómo entrar al SMP?</h2>
          <p className="text-lg text-white/80">
            Si te interesa jugar con nosotros, únete al Discord, dirígete al canal <strong>#data</strong>,
            abre un ticket y completa el formulario. El equipo revisará tu solicitud y te acompañará durante el ingreso.
          </p>

          <div className="grid gap-3 sm:grid-cols-2">
            {[
              { step: "1", label: "Únete al Discord", detail: "Ingresa al servidor oficial" },
              { step: "2", label: "Ticket en #data", detail: "Abre el ticket y sigue los pasos" },
              { step: "3", label: "Formulario", detail: "Comparte tu experiencia y estilo" },
              { step: "4", label: "Tour de bienvenida", detail: "Conoce las bases y reglas" },
            ].map((item) => (
              <div
                key={item.step}
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <span className="text-sm text-white/60">Respuesta rápida de la comunidad</span>
          </div>
        </div>
