...
export default function Nosotros() {
    return (
        <div className="container flex flex-col mx-auto max-w-6xl rounded-3xl border border-triskgold/20 bg-black/30 px-6 p-4 md:px-10 shadow-2xl backdrop-blur">
          <h2 className="m-4 text-4xl font-bold text-triskgold drop-shadow-lg">Sobre nosotros</h2>
          <div className="m-2 my-20 flex flex-wrap items-center justify-between w-full">
            <div className="px-6 md:px-10 w-full md:w-1/2 p-4">
              ...
              <p className="w-5/6 m-4 py-2 text-lg text-white/75 mb-6">
