...
export default async function MembersPage() {
    ...
    return (
        <div className='relative mx-auto flex max-w-6xl flex-col gap-10 px-4 py-10'>
            <div className='border-triskgold/20 container mx-auto flex max-w-6xl flex-col rounded-3xl border bg-black/30 px-3 py-4 md:px-6 md:py-6'>
                ...
                <div className='w-full p-4 px-6 md:px-10'>
                    <h3 className='text-triskgold m-4 text-4xl font-bold drop-shadow-lg'>
                        Miembros historicos
                    </h3>
