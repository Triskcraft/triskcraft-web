...
export default function HomePage() {
  ...
  return (
    <div className="relative mx-auto flex max-w-6xl flex-col gap-16 px-4 py-10">
        ...
        <div className="relative flex flex-col gap-10 p-8 md:flex-row md:items-center md:justify-between md:p-12">
          <div className="space-y-6 text-white md:w-1/2">
            ...
            <p className="max-w-2xl text-lg text-white/80">
              Triskcraft es un Survival MultiPlayer con una comunidad sana y dedicada a crear e innovar en todo lo que tiene que ver con Minecraft Técnico, Redstone y decoración. Nuestra meta es crecer y construir proyectos cada vez más grandes con diseño propio e innovador.
            </p>
            ...
            <div className="grid grid-cols-1 gap-4 pt-4 sm:grid-cols-3">
              {[
                { title: "Experiencia Técnica", text: "Automatización y builds optimizadas", accent: "Builds" },
                { title: "Eventos Comunidad", text: "Retos, tours y showcases en vivo", accent: "Eventos" },
                { title: "Creatividad Libre", text: "Estilo decorativo con identidad propia", accent: "Estilo" },
              ].map((item) => (
                <div
                  key={item.title}
      ...
      <div className="w-full overflow-hidden rounded-3xl border border-triskgold/20 bg-gradient-to-r from-[#0a1b15] via-triskgreen to-[#0f2f23] p-8 shadow-2xl md:p-12">
        <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
          <div className="space-y-3 md:w-2/3">
            <p className="text-sm uppercase tracking-[0.3em] text-triskgold/80">Explora</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">Tours dentro del Servidor</h2>
            <p className="max-w-2xl text-lg text-white/80">
              Descubre las bases, granjas y proyectos técnicos a través de recorridos guiados por la comunidad.
              Cada tour revela el cuidado por el detalle y el uso avanzado de redstone y decoración.
            </p>
          </div>
          <a
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Videocard id="0-E_lBWVs9c" nombre="Lo mejor del SMP (Destacado)" />
          <Videocard id="0-E_lBWVs9c" nombre="Recorrido técnico y decoración" />
        </div>
      </div>
